    ...
    <div className="space-y-6 animate-fade-in max-w-4xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Record a new spend or receipt on the go.
          </p>
        </div>
      ...
      <Card className="text-center py-16 px-6 border-dashed border-2 border-indigo-200 bg-indigo-50/20">
        ...
        <h3 className="text-xl font-bold text-slate-800 mb-2">
          Add Expense Module Reserved
        </h3>
        <p className="text-sm text-slate-500 max-w-md mx-auto mb-6 leading-relaxed">
          This page is designated for your teammate's implementation of quick spend entry, UPI receipt scanning, and category tagging.
        </p>
        <Link
          to="/dashboard"
