    ...
    <div className="space-y-6 animate-fade-in max-w-4xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Manage your student account and university credentials.
          </p>
        </div>
      ...
      <Card className="text-center py-16 px-6 border-dashed border-2 border-indigo-200 bg-indigo-50/20">
        ...
        <h3 className="text-xl font-bold text-slate-800 mb-2">
          Profile Workspace Reserved
        </h3>
        <p className="text-sm text-slate-500 max-w-md mx-auto mb-6 leading-relaxed">
          This section is designated for your teammate's implementation of college student profile details, avatars, and graduation milestones.
        </p>
        <Link
          to="/dashboard"
