...
export const MOCK_EXPENSES = [
  // --- September 2026 (Current Month) — Total Spent: EXACTLY ₹4,760 ---
  // Food: ₹1,450 | Transport: ₹620 | Education: ₹850 | Entertainment: ₹700
  // Shopping: ₹450 | Subscriptions: ₹240 | Accommodation: ₹300 | Other: ₹150

  // 1. Recent Transactions (Sep 08 & Sep 07)
  {
    id: "exp-001",
